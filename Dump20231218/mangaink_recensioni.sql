...
CREATE TABLE `recensioni` (
  ...
  `transazioneFK` int NOT NULL,
  `voto` double NOT NULL,
  `Descrizione` varchar(45) DEFAULT NULL,
  `utenteRecensore` int NOT NULL,
  PRIMARY KEY (`idRecensioni`),
  KEY `utenteRecensore_idx` (`utenteRecensore`),
  KEY `transazioneFK_idx` (`transazioneFK`),
  CONSTRAINT `transazioneFK` FOREIGN KEY (`transazioneFK`) REFERENCES `transazioni` (`idTransazioni`),
  CONSTRAINT `utenteRecensore` FOREIGN KEY (`utenteRecensore`) REFERENCES `utente` (`idutente`)
