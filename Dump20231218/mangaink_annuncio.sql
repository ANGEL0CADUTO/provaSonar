...
CREATE TABLE `annuncio` (
  ...
  `IstanzaManga` int NOT NULL,
  `PrezzoDiVendita` decimal(10,2) NOT NULL,
  `StatoAnnuncio` varchar(45) NOT NULL,
  `dataAnnuncio` datetime NOT NULL,
  PRIMARY KEY (`idAnnuncio`),
  KEY `istanzaLibro_idx` (`IstanzaManga`),
  CONSTRAINT `istanzaLibro` FOREIGN KEY (`IstanzaManga`) REFERENCES `copiemanga` (`idLibroUtente`)
...
INSERT INTO `annuncio` VALUES (1,1,5.99,'venduto','2023-01-01 12:30:00');
